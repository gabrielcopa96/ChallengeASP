...
namespace WB.EntrevistaABP.Migrations
{
    ...
    [Migration("20230909011457_migration_viaje_entrevistaabp")]
    partial class migrationviajeentrevistaabp
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WB.EntrevistaABP.Viajes.DetalleViaje", b =>
                {
                    ...
                    b.ToTable("DetalleViajes", (string)null);
                });
            ...
            modelBuilder.Entity("WB.EntrevistaABP.Viajes.DetalleViaje", b =>
                {
                    b.HasOne("WB.EntrevistaABP.Pasajeros.Pasajero", null)
                        .WithMany()
                        .HasForeignKey("PasajeroId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("WB.EntrevistaABP.Viajes.Viaje", null)
